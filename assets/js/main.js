/**
 * Constructora Ara-Chile — Fase 2 + Filtro Flota B2B
 * Vanilla JS: nav, modal, contadores, lightbox, fleet filter
 */
(function () {
  'use strict';
  ...
  /* ---------- Filtro dinámico de flota B2B ---------- */
  var filterBar = document.querySelector('.fleet-filter');
  var fleetCards = document.querySelectorAll('.fleet-card');
  var fleetEmpty = document.getElementById('fleet-empty');

  if (filterBar && fleetCards.length) {
    filterBar.addEventListener('click', function (e) {
      ...
      // Toggle activo sin recálculos de layout pesados: solo clases
